 ...
 */
final class Version20211122174430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film (id INT AUTO_INCREMENT NOT NULL, genre_id INT DEFAULT NULL, director_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, duree VARCHAR(255) NOT NULL, date DATE NOT NULL, affiche VARCHAR(510) DEFAULT NULL, INDEX IDX_8244BE224296D31F (genre_id), INDEX IDX_8244BE22899FB366 (director_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
